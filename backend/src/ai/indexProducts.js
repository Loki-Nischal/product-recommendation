// backend/src/ai/indexProducts.js
// One-time batch script: generates embeddings for ALL products in MongoDB
// Usage (from backend/ folder): node src/ai/indexProducts.js
